...
# 
def trackCards(frame, old_gray, frame_gray, cardsInView, cardFeatures, showTracking = False):
...
# Set up tracking
cardFeatures, cardsInView = initTrackCards(old_gray, cardsToTrack)
...
while(1):
	...
	trackCards(frame, old_gray, frame_gray, cardsInView, cardFeatures, showTracking = True)

	# Print cards in terminal
	# printCards(cardsInView)
	
	# Print cards in frame
	showCardsInFrame(frame, cardsInView)
